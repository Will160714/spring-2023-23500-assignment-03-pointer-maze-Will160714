 ...
 */
const std::string kYourName = "Patrick";
//TODO: Replace this string with your name.

/* Change these constants to contain the paths out of your mazes. */
const std::string kPathOutOfNormalMaze = "WSESWSEWWNNNWSS";
//WSESWSEWWNNNWSS
const std::string kPathOutOfTwistyMaze = "SNNWSNSESSSWS";
//SNNWSNSESSSWS

int main() {
    /* Generate the maze.
     *
     * Note: Don't set a breakpoint on this line.ma Otherwise, you'll see startLocation before
